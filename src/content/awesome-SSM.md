...
# Basics
- [Mamba, Mamba2](/posts/from-mamba-to-mamba2/)

# Bidirectional
- [Hydra](/posts/hydra-a-double-headed-mamba/)

# Attention Hybrids
- [SSM-Transformer Hybrids](/posts/ssm-transformer-hybrids-guide/) covers:
...
- [Hymba](/posts/hymba-new-ssm-att-hybrid-breed/)
...
- [Illusion of State in SSMs like Mamba](/posts/ssm-the-illusion/) covers:
...
# Distillation
- [Hohawk and Mamba in the Llama](/posts/distilling-ssm-from-transformers/) covers:
