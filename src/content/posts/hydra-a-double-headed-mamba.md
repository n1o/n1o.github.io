...
We build upon research done in [State Space Duality](/posts/from-mamba-to-mamba2/) and the Mamba2 model. The main idea of Mamba2 is to express a State Space Model as:
...
- more on [SSD](/posts/from-mamba-to-mamba2/#pytorch)
