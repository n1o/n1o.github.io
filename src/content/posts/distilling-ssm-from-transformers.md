...
To a certain degree, the authors build upon the research done in [[State Space Duality]](/posts/from-mamba-to-mamba2/), which focused on the connection between Linear Attention and the Recurrent form of State Space Models. 
