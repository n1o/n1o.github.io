...
I have been working on a project of creating my own Large Language Model, as I am huge fan of T5, or to be more concrete I recognize the added value of having an Encoder-Decoder architecture. The biggest challenge, at least in my opinion, in training an LLM is the sheer computational costs required to do so. I was originally planning to take the Encoder introduced by [ColT5](/posts/longer-context-for-t5/) but than I came across of [M2 BERT](https://hazyresearch.stanford.edu/blog/2024-05-20-m2-bert-retrieval) and suddenly I went down the rabbit hole of Structured Matrices, Butterflies, Monarch and Hyeans.
...
What is the deal with the Hyena anyway? Everything comes from the [Hyena Hierarchy](https://arxiv.org/abs/2302.10866) paper. In short, they take the ideas introduced at [H3](/posts/hungry-hungry-hippos/) and further generallize them, introducing the Hyena Operator.
